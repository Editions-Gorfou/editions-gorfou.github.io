  ...
  return (
    <>
      ...
      <div className="container m-5 mx-auto">
        ...
        <p>Si vous n’obtenez pas de réponse au bout de deux mois, considérez que votre manuscrit n’a pas retenu notre attention. Toutefois nous nous efforcerons de vous fournir un retour aussi informatif que possible.</p>
      </div>
    </>
  )
}