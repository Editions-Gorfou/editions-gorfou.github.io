  ...
  return (
    <>
      ...
      <div className="container m-5 mx-auto">
          ...
          <p className="mb-5">Les Éditions Gorfou, c’est une maison d’édition <strong>indépendante</strong>, <strong>à compte d’éditeur</strong> et <strong>dans l’ère du temps</strong> :</p>
          <ul className="list-disc ml-5 mb-5">
              ...
              <li><strong>dans l’ère du temps</strong>, parce qu’on ne vous demandera pas d’imprimer un manuscrit à l’ère du numérique et que notre objectif est de faciliter la collaboration entre les auteurs et nous-mêmes.</li>
          </ul>
